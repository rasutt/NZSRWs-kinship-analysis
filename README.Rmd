...
Things to do:
- Update the report.  Don't need too much detail, just the main results/explanation.
- Add a link to my dissertation for explanation.
...
Maybe have the proportions of loci with one or two alleles shared, along with the msat only likelihoods here.
