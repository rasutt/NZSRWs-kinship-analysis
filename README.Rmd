...
For each pair it finds the number of microsatellite loci at which they share one or two alleles, as a simple heuristic for kinship, then it finds the precise likelihoods given to various simple kinships by all of the data, and the half-sibling versus unrelated pair PLODS.  
...
hist(
  hsp_up_plods_comp, 
  breaks = 200,
  main = "Half-sibling vs unrelated pair PLODs 
